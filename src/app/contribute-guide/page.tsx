...
export const metadata: Metadata = {
  title: "Contribute to Open Tool Kit - Join Our Developer Community",
  description:
    "Learn how to contribute to Open Tool Kit. Add new tools, fix bugs, and help build the most comprehensive collection of developer utilities. Step-by-step guide included.",
  keywords:
  ...
  openGraph: {
    title: "Contribute to Open Tool Kit - Join Our Developer Community",
    description:
      "Learn how to contribute to Open Tool Kit. Add new tools, fix bugs, and help build the most comprehensive collection of developer utilities.",
    type: "website",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Open Tool Kit - Contribute Guide for Developers",
      },
    ],
  },
  twitter: {
